...
export function ExperienceSection({ experiences }: ExperienceSectionProps) {
  return (
    <section className="mx-auto max-w-6xl px-5 py-16 sm:px-6 lg:px-8" id="experience">
      <SectionTitle
        eyebrow="Experience"
        title="학습과 프로젝트 경험"
      ...
      <div className="mt-10 space-y-6">
        {experiences.map((experience) => (
          <article
            className="relative rounded-lg border border-slate-200 bg-white p-6 sm:pl-8"
